...
# Output
my_output <- paste("data/users/lland/assembly_annotation_course/busco/busco_No-0/all/","busco_figure.png",sep="/") 
...
# Load BUSCO summary table
busco <- read_tsv("/data/users/lland/assembly_annotation_course/busco/busco_No-0/busco_summary.tsv")

# Expand into long format (S, D, F, M per assembly)
