...
# Output
my_output <- paste("data/users/lland/assembly_annotation_course/busco/all/","busco_figure.png",sep="/") 
...
busco <- read_tsv("/data/users/lland/assembly_annotation_course/busco/busco_summary.tsv")
